...
Vec Vec::operator+(const Vec& other) { return Vec(this->x + other.x, this->y + other.y); }
Vec Vec::operator-(const Vec& other) { return Vec(this->x - other.x, this->y - other.y); }
...
void Triangle::draw() {
	...
	glVertex2f(this->getAnchor().getX() + cosf(this->getangle()) * this->getlen(),
	           this->getAnchor().getY() + sinf(this->getangle()) * this->getlen());
	glVertex2f(this->getAnchor().getX() +
	               cosf(this->getangle() + static_cast<float>(2 * M_PI / 3)) * this->getlen(),
	           this->getAnchor().getY() +
	               sinf(this->getangle() + static_cast<float>(2 * M_PI / 3)) * this->getlen());
	glVertex2f(this->getAnchor().getX() +
	               cosf(this->getangle() - static_cast<float>(2 * M_PI / 3)) * this->getlen(),
	           this->getAnchor().getY() +
	               sinf(this->getangle() - static_cast<float>(2 * M_PI / 3)) * this->getlen());
...
Right_Triangle::Right_Triangle(Vec anchor, float angle, float u_length, mycolor color) {
	setAnchor(anchor);
	setangle(angle);
	setlen(u_length);
	setcolor(color);
...
void Right_Triangle::draw() {
	...
	glVertex2f(this->getAnchor().getX() +
	           ...
	           this->getAnchor().getY() +
	               sinf(this->getangle() + static_cast<float>(2 * M_PI / 3)) * this->getlen());
	glVertex2f(
	    this->getAnchor().getX() + (cosf(this->getangle() + static_cast<float>(2 * M_PI / 3)) +
	                                cosf(this->getangle() - static_cast<float>(2 * M_PI / 3))) *
	                                   this->getlen() / 2,
	    this->getAnchor().getY() + (sinf(this->getangle() - static_cast<float>(2 * M_PI / 3)) +
...
Rectangle::Rectangle(Vec anchor, float angle, float u_length, mycolor color, float angle1) {
	setAnchor(anchor);
	setangle(angle);
	setlen(u_length);
	setcolor(color);
...
void Rectangle::draw() {
	...
	glBegin(GL_POLYGON);
	glColor3f(this->getcolor().r, this->getcolor().g, this->getcolor().b);
	glVertex2f(this->getAnchor().getX() + cosf(this->getangle() + this->angle1) * this->getlen(),
	           this->getAnchor().getY() + sinf(this->getangle() + this->angle1) * this->getlen());
	glVertex2f(this->getAnchor().getX() + cosf(this->getangle() - this->angle1) * this->getlen(),
	           this->getAnchor().getY() + sinf(this->getangle() - this->angle1) * this->getlen());
	glVertex2f(
	    this->getAnchor().getX() +
	        cosf(static_cast<float>(M_PI) + this->getangle() + this->angle1) * this->getlen(),
	    this->getAnchor().getY() +
	        sinf(static_cast<float>(M_PI) + this->getangle() + this->angle1) * this->getlen());
	glVertex2f(
	    this->getAnchor().getX() +
	        cosf(static_cast<float>(M_PI) + this->getangle() - this->angle1) * this->getlen(),
	    this->getAnchor().getY() +
...
Trapezium::Trapezium(Vec anchor, float angle, float u_length, mycolor color, float ratio,
...
void Trapezium::draw() {
	...
	glColor3f(this->getcolor().r, this->getcolor().g, this->getcolor().b);
	glVertex2f(this->getAnchor().getX() +
	               cosf(this->getangle() + this->angle1) * this->getlen() * this->ratio,
	           this->getAnchor().getY() +
	               sinf(this->getangle() + this->angle1) * this->getlen() * this->ratio);
	glVertex2f(this->getAnchor().getX() +
	               cosf(this->getangle() - this->angle1) * this->getlen() * this->ratio,
	           this->getAnchor().getY() +
	               sinf(this->getangle() - this->angle1) * this->getlen() * this->ratio);
	glVertex2f(
	    this->getAnchor().getX() +
	        cosf(static_cast<float>(M_PI) + this->getangle() + this->angle2) * this->getlen(),
	    this->getAnchor().getY() +
	        sinf(static_cast<float>(M_PI) + this->getangle() + this->angle2) * this->getlen());
	glVertex2f(
	    this->getAnchor().getX() +
	        cosf(static_cast<float>(M_PI) + this->getangle() - this->angle2) * this->getlen(),
	    this->getAnchor().getY() +

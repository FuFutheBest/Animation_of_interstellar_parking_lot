...
class Figure {
   ...
   public:
	Figure(Vec anchor = Vec{0.0f, 0.0f}, float angle = 0.0f, float u_length = unit,
...
class Circle : public Figure {
   public:
	explicit Circle(Vec anchor = Vec{0.0f, 0.0f}, float angle = 0.0f, float u_length = unit,
	                mycolor color = {0.0f, 0.0f, 0.f});
	~Circle() = default;
	void draw() override;
};
...
class Semicircle : public Circle {
   public:
	explicit Semicircle(Vec anchor = Vec{0.0f, 0.0f}, float angle = 0.0f, float u_length = unit,
	                    mycolor color = {0.0f, 0.0f, 0.f});
	~Semicircle() = default;
	void draw() override;
};
...
class Triangle : public Figure {
   public:
	explicit Triangle(Vec anchor = Vec{0.0f, 0.0f}, float angle = 0.0f, float u_length = unit,
	                  mycolor color = {0.0f, 0.0f, 0.f});
	~Triangle() = default;
	void draw() override;
};
...
class Right_Triangle : public Triangle {
   public:
	explicit Right_Triangle(Vec anchor = Vec{0.0f, 0.0f}, float angle = 0.0f, float u_length = unit,
	                        mycolor color = {0.0f, 0.0f, 0.f});
...
class Rectangle : public Figure {
   ...
   public:
	explicit Rectangle(Vec anchor = Vec{0.0f, 0.0f}, float angle = 0.0f, float u_length = unit,
	                   mycolor color = {0.0f, 0.0f, 0.f},
...
class Trapezium : public Figure {
   ...
   public:
	explicit Trapezium(Vec anchor = Vec{0.0f, 0.0f}, float angle = 0.0f, float u_length = unit,
	                   mycolor color = {0.0f, 0.0f, 0.f}, float ratio = 0.5,
	                   float angle1 = static_cast<float>(M_PI / 6),
